...
<html lang="pt-br">
	...
	<body>
		...
		<h1>Lista Insumos Cadastrados</h1>
		<?php
		...
		while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)){
			...
			echo "Agua: " . $row_usuario['agua'] . "<br>";
			echo "Alcool: " . $row_usuario['alcool'] . "<br>";
			echo "Fragrancia: " . $row_usuario['fragrancia'] . "<br><br>";
		}
		...
		?>		
		<input type="button" value="Tela: Mistura de Ingredientes"
